...
import { CONFIG_FILE_NAME, setCompileFlags } from '@eclipse-cdt-cloud/clangd-contexts';
import * as vscode from 'vscode';
import { findMatchingFiles, restartClangdLanguageServer } from './util';
export const IGNORE_GCC_FLAGS_COMMAND = 'cdtcloud-clangd-contexts.ignore.gccFlags';
