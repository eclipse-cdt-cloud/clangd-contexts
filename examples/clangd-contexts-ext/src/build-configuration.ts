...
import { getContext, setContext, ClangdContext } from '@eclipse-cdt-cloud/clangd-contexts';
...
export const CHANGE_BUILD_CONFIGURATION_COMMAND = 'cdtcloud-clangd-contexts.change.buildConfig';
